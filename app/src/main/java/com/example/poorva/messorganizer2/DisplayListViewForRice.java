...
public class DisplayListViewForRice extends AppCompatActivity {

    String json_string,json_string1,JSON_STRING;
    JSONObject jsonObject;
    JSONArray jsonArray;
    ContactAdapterForRice contactAdapterForRice;
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_listview_for_rice);
        ...
        contactAdapterForRice=new ContactAdapterForRice(this,R.layout.activity_row_layout_rice);
        listView.setAdapter(contactAdapterForRice);
        try {
            ...
            while (count<jsonArray.length())
            {
                ...
                ContactsForRice contactsForRice=new ContactsForRice(srno,itemName,taste);
                contactAdapterForRice.add(contactsForRice);
                count++;
            }
    ...
    public void saveInfoToRice(/*String[] arrayOfRetreivedStrings*/View view)
    {
        //////
        ...
        else
        {
            ...
            Intent i=new Intent(this,DisplayListViewForBread.class);
            i.putExtra("json_data",json_string1);
            i.putExtra("activity","DisplayListViewForBread");
...
//    }
    ...
    class BackgroundTask extends AsyncTask<String[],Void,String>
    {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            add_info_url="https://year3.000webhostapp.com/add_info_to_todaysRiceMenu.php";
        }
    ...
    /////Inner class 2
    //Inner class for extracting json objects from breads table
    //////////////////////
    ...
    public class BackGroundTask1 extends AsyncTask<Void,Void,String> {
        ...
        @Override
        protected void onPreExecute() {
            json_url="https://year3.000webhostapp.com/json_get_data_bread.php";
        }
