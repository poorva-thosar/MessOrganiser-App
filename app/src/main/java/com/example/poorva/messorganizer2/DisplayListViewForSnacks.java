...
public class DisplayListViewForSnacks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_listview_for_snacks);
...
//    }
    ...
    class BackgroundTask extends AsyncTask<String[],Void,String>
    {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            add_info_url="https://year3.000webhostapp.com/add_info_to_todaysSnacksMenu.php";
        }
