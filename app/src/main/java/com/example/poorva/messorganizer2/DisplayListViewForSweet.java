...
public class DisplayListViewForSweet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_listview_for_sweet);
        ...
        contactAdapter=new ContactAdapter(this,R.layout.activity_row_layout_snacks);
    ...
    public void saveInfo(/*String[] arrayOfRetreivedStrings*/View view)
    {
        ...
        else
        {
            ...
            Intent i=new Intent(this,DisplayListViewForSnacks.class);
            i.putExtra("json_data",json_string1);
            i.putExtra("activity","DisplayListViewForSnacks");
...
//    }
    ...
    class BackgroundTask extends AsyncTask<String[],Void,String>
    {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            add_info_url="https://year3.000webhostapp.com/add_info_to_todaysSweetMenu.php";
        }
    ...
    public class BackGroundTask1 extends AsyncTask<Void,Void,String> {
        ...
        @Override
        protected void onPreExecute() {
            json_url="https://year3.000webhostapp.com/json_get_data_for_snacks.php";
        }
