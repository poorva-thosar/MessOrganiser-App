...
//
//public class DisplayListViewForVegetable extends AppCompatActivity {
//
...
//        setContentView(R.layout.activity_didplay_listview_for_vegetable);
//
...
//        contactAdapterForVegetable=new ContactAdapterForForVegetable(this,R.layout.activity_row_layout);
//        listView.setAdapter(contactAdapterForVegetable);
//        try {
...
//                ContactsForVegetable contactsForVegetable=new ContactsForVegetable(srno,itemName,taste);
//                contactAdapterForVegetable.add(contactsForVegetable);
//                count++;
//            }
//
...
//        else
//        {
//            DisplayListViewForVegetable.BackgroundTask backgroundTask = new BackgroundTask();
//            backgroundTask.execute(arrayOfRetreivedString);
//            finish();
//
//
//            Intent i=new Intent(this,DisplayListViewForRice.class);
//            i.putExtra("json_data",json_string1);
//            i.putExtra("activity","DisplayListViewForRice");
//
//            startActivity(i);
//        }
//    }
//
//
////    public void parseJSONForRice(View view)
////    {
////
////        if(json_string1==null)
////        {
...
//
//    /////Inner class 2
//    //Inner class for extracting json objects from rice table
//    //////////////////////
//
...
//        @Override
//        protected void onPreExecute() {
//            json_url="https://year3.000webhostapp.com/json_get_data_rice.php";
//        }
//
//        @Override
...
public class DisplayListViewForVegetable extends AppCompatActivity {
    ...
    ListView listView;
    int indexForArrayOfRetreivedString=0;
    Button submitButtonForCreateTodaysMenu,createOrderButton;
    String[] arrayOfRetreivedString=new String[100];
    int countOfArrayLength;
    int index;
    Button NextPage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtBill = findViewById(R.id.txtBillAmount);

        txtBill.setText("0");
        createOrderButton = findViewById(R.id.btnNextToCreateOrder);
        Intent intent = getIntent();
        String activityContext = intent.getStringExtra("activity");

        String co = "CreateOrder";
        String cm = "CreateMenu";

        //   Toast.makeText(getApplicationContext(),"Previous Activity is " + activityContext , Toast.LENGTH_SHORT).show();

        if(activityContext.equals(co)) {        //If activity is CreateOrder
            //      Toast.makeText(getApplicationContext(), "Previous Activity is " + activityContext, Toast.LENGTH_SHORT).show();
            submitButtonForCreateTodaysMenu.setVisibility(View.INVISIBLE);
        }

        if(activityContext.equals(cm)){             //ADDITION
            Toast.makeText(getApplicationContext(), "Previous Activity is " + activityContext, Toast.LENGTH_SHORT).show();
            createOrderButton.setVisibility(View.INVISIBLE);
            txtTotal.setVisibility(View.INVISIBLE);
            txtBill.setVisibility(View.INVISIBLE);
        }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long l) {
                ...
                if(view.isActivated())
                {
                    ...
                    String retreivedName =((TextView)view.findViewById(R.id.tx_name)).getText().toString();
                    String retrievedSrNo =((TextView)view.findViewById(R.id.tx_srno)).getText().toString();
                    String retrivedCost =((TextView)view.findViewById(R.id.tx_taste)).getText().toString();
                    Toast.makeText(getApplicationContext(),retreivedName+" Unselected",Toast.LENGTH_SHORT).show();

                    totalBill -=Integer.parseInt(retrivedCost);
                    txtBill.setText(Integer.toString(totalBill));
                ...
                else
                {
                    ...
                    arrayOfRetreivedString[indexForArrayOfRetreivedString++]=retrievedSrNo;
                    arrayOfRetreivedString[indexForArrayOfRetreivedString++]=retreivedName;
                    arrayOfRetreivedString[indexForArrayOfRetreivedString++]=retrivedCost;
                    countOfArrayLength+=3;
